...
- [Base de code](https://github.com/OpenClassrooms-Student-Center/booki-starter-code.git)
 ...
 #### Guide d'étapes
Afin de vous aider à réaliser ce projet, vous pouvez consulter ce [guide](https://course.oc-static.com/projects/D%C3%A9veloppeur+Web/IW_P3+HTML+CSS+Booki/IW+%3A+React+Booki+-+Etapes+cles.pdf) d’étapes à suivre, qui contient des recommandations et des ressources pour organiser votre travail.
